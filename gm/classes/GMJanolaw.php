...
class GMJanolaw_ORIGIN
{
	...
	{
		$this->m_user_id = defined('MODULE_GAMBIO_JANOLAW_USER_ID') ? xtc_cleanName(MODULE_GAMBIO_JANOLAW_USER_ID) : '';
		$this->m_shop_id = defined('MODULE_GAMBIO_JANOLAW_SHOP_ID') ? xtc_cleanName(MODULE_GAMBIO_JANOLAW_SHOP_ID) : '';
	...
	public function mapLanguage($language_iso_2)
	{
		...
		elseif(($this->multilang ?? null) === true && $language_iso_2 === 'en')
		{
			$mappedLanguage = 'gb';
		}
		else
